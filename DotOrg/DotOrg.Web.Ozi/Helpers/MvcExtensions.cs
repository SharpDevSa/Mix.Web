...
namespace DotOrg.Web.Ozi.Helpers
{
	public static class MvcExtensions
	{
		...
		//public static string Image(this UrlHelper helper, IFileEntity file)
		//{
		//	if (file == null)
		//		return null;
		//	return helper.Image(file.Url, strategy);
		//}

		//public static string Image(this UrlHelper helper, IFileEntity file, int width, int height, FillType fill)
		//{
		//	return helper.Image((file == null) ? null : file.Name, width, height, strategy);
		//}

		//public static IHtmlString Image(this HtmlHelper helper, IFileEntity file, FillType fill = FillType.Proportional, object attrs = null)
		//{
		//	return helper.Image((file == null) ? null : file.Url, fill, attrs);
		//}

		//public static IHtmlString Image(this HtmlHelper helper, IFileEntity file, int width, int height, FillType fill = FillType.Proportional, object attrs = null)
		//{
